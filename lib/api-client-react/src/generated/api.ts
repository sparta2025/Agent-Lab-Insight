 ...
 */
export const listAgents = async ( options?: Parameters<typeof customFetch>[1]): Promise<AgentInfo[]> => {
 ...
 */
export const listTasks = async ( options?: Parameters<typeof customFetch>[1]): Promise<TaskRecord[]> => {

  return customFetch<TaskRecord[]>(getListTasksUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const createTask = async (taskInput: TaskInput, options?: Parameters<typeof customFetch>[1]): Promise<TaskRecord> => {
 ...
 */
export const getTask = async (taskId: string, options?: Parameters<typeof customFetch>[1]): Promise<TaskRecord> => {
